          ...
          <div className="row">
            <div className="col s12 m6">
              <div className="card">
                <div className="card-content">
                  <p>
                    <span className="card-title"><a href="www.google.fr" className="teal-text hoverline">Muay Thai Fan</a></span>
                  </p>
            ...
            <div className="col s12 m6">
              <div className="card">
                <div className="card-content">
                  <p>
                    <span className="card-title"><a href="www.google.fr" className="teal-text hoverline">Video Games Fan</a></span>
                  </p>
